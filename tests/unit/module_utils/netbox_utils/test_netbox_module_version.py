...
def test_version_check_greater_true(mock_netbox_module_version, mock_nb_resp, version):
    """
    _version_check_greater returns True
    for versions greater than a baseline.
    """
    mock_netbox_module_version.nb_object = mock_nb_resp
...
def test_version_check_greater_false(mock_netbox_module_version, mock_nb_resp, version):
    """
...
def test_version_check_greater_equal_to_true(
    mock_netbox_module_version, mock_nb_resp, version
):
    """
    _version_check_greater returns True
...
def test_version_sanitize_to_true(
    mock_netbox_module_version, mock_nb_resp, raw_value, expected
):
    """
...
def test_version_sanitize_value_error(
    mock_netbox_module_version, mock_nb_resp, version
):
    """
